...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (response.statusCode == 200 && json['success'] == true) {
        ...
        setState(() => _error = (json['error'] as String?) ?? 'Login failed');
      }
    } on TimeoutException {
  ...
  Future<void> _saveUserData(Map<String, dynamic> json) async {
    ...
    // store under the key LaunchGate expects
    await prefs.setString('jwt_token', json['access_token'] ?? '');
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildInputField(
                                    _usernameCtl, 'example@umich.edu', Icons.person_outline),
